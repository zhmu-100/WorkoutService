    ...
    route("/training/workouts") {
      post {
        try {
          ...
          loggerClient.logActivity(
              ...
              additionalData = mapOf("workoutId" to created.id, "workoutName" to created.name))
      ...
      get("{id}") {
        try {
          ...
          loggerClient.logActivity(
              event = "API: Запрос тренировки по ID", additionalData = mapOf("workoutId" to id))
        ...
        try {
          ...
          if (updated == null) {
            ...
            loggerClient.logActivity(
                ...
                additionalData = mapOf("workoutId" to id, "workoutName" to updated.name))
      ...
      post("/custom") {
        try {
          ...
          loggerClient.logError(
              ...
              stackTrace = e.stackTraceToString())
          call.respond(
              HttpStatusCode.InternalServerError, "Error creating custom workout: ${e.message}")
        }
      }
    }
  }
